...
class Activity {
     ...
     */
    metricMeter;
    constructor(info, fn, dataConverter, heartbeatCallback, workerLogger, workerMetricMeter, interceptors) {
        this.info = info;
        this.fn = fn;
    ...
    runNoEncoding(fn, input) {
        ...
        return activity_1.asyncLocalStorage.run(this.context, () => this.execute(fn, input));
    }
}
